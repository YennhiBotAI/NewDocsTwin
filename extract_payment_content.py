...
def extract_payment_content():
    # Read the HTML file
    with open("2.2. Hướng dẫn Thanh toán _ Twin AI Docs.html", "r", encoding="utf-8") as f:
        content = f.read()
    ...
    print("=== EXTRACTED PAYMENT GUIDE CONTENT ===")
    for i, content in enumerate(extracted_content, 1):
        print(f"{i}. {content}")
        print()

if __name__ == "__main__":
    extract_payment_content()
